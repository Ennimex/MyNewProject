export async function getLatestGames() {
  ...
  export async function getGameDetails(slug: string) {
    ...
    // get the card image
    const cardImage = images.find((image: { typeName: string; bucketType: string; bucketPath: string }) => image.typeName === "cardImage");
    ...
    // get the reviews
    const reviews = rawReviews.map((review: { quote: string; score: number; date: string; publicationName: string; author: string }) => {
